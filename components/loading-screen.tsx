        ...
        <main className="flex-1 flex bg-white">
          <div className="flex w-full justify-center items-center">
            ...
            <div className="flex flex-col lg:flex-row w-full max-w-7xl mx-auto">
              ...
              {/* Loading section - agora ocupa toda a largura em mobile */}
              <div className="w-full lg:w-[380px] bg-white p-4 sm:p-6 flex flex-col justify-center lg:ml-4">
                <div className="max-w-sm mx-auto w-full text-center">
                  <h2 className="text-xl sm:text-2xl font-normal text-gray-900 mb-6 sm:mb-8 text-center">Entrando na reunião...</h2>
                  <p className="mb-8 text-gray-600">Você irá entrar na reunião em poucos segundos, aguarde um momento...</p>
                  <div className="flex justify-center mb-8">
                    <div className="h-12 w-12 animate-spin rounded-full border-4 border-blue-600 border-t-transparent"></div>
                  </div>
                  <div className="text-sm text-gray-500">Entrando como {userName}</div>
                </div>
              </div>
            </div>
          </div>
